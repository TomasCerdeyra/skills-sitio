# Reference: `README.md` del proyecto

Path destino: `README.md`

README mínimo para el cliente. Reemplazar `{NOMBRE_CLIENTE}`, `{SLUG}`, `{PLAN}` con valores reales.

```markdown
# {NOMBRE_CLIENTE}

Sitio web de {NOMBRE_CLIENTE} construido con SitioHoy.
