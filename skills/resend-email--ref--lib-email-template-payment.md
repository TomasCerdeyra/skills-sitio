...
- `escapeHtml` previene injection de HTML/XSS si los items o el código de cupón vienen con caracteres especiales.
- Los estilos son inline porque los clientes de email (Gmail, Outlook) no soportan stylesheets externos ni clases.
- El template renderiza correctamente en Gmail, Outlook web, Apple Mail. Para casos complejos usar [react-email](https://react.email).
