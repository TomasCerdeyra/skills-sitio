...
BEGIN
  ...
  VALUES ('Estudio Méndez', 'estudio-mendez', 'esencial', 'active', 50)
...
-- Plan Esencial NO usa: orders, order_items, coupons, shipping_zones
...
-- =============================================
-- 4. Políticas — tenants, user_tenants
-- =============================================
