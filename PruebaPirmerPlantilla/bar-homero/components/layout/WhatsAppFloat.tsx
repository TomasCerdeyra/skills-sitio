...
export default function WhatsAppFloat() {
  const link = buildWhatsAppLink({ message: "Hola! Vi tu carta online y quería hacer una consulta" });
  ...
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-30 w-14 h-14 rounded-full bg-[#25D366] text-white shadow-lg flex items-center justify-center hover:scale-110 transition-transform"
    >
