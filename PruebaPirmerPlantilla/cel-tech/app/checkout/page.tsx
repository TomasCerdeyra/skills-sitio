    ...
    <div className="bg-neutral-50 min-h-screen pt-20">
      <div className="max-w-2xl mx-auto px-5 py-12">
        <div className="flex items-center gap-2 font-body text-sm mb-10">
          ...
          <span className="text-neutral-400">Datos del pedido</span>
          <span className="text-neutral-300">→</span>
          <span className="text-neutral-900 font-semibold">Pago</span>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-neutral-200 p-6">
          ...
          {loading && (
            <div className="py-16 text-center">
              <div className="inline-block w-10 h-10 border-3 border-neutral-200 border-t-brand-primary rounded-full animate-spin" />
              <p className="font-body text-neutral-400 mt-4 text-sm">Preparando el pago...</p>
            </div>
          )}
          ...
          {processing && (
            <div className="fixed inset-0 bg-neutral-900/50 flex items-center justify-center z-50">
              <div className="bg-white rounded-2xl p-8 text-center shadow-2xl">
                <div className="inline-block w-10 h-10 border-3 border-neutral-200 border-t-brand-primary rounded-full animate-spin mb-4" />
                <p className="font-body text-neutral-600">Procesando pago...</p>
              </div>
            </div>
          )}
