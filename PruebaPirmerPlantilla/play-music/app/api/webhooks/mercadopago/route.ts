  ...
  try {
    ...
    if (body.type === "payment" && body.data?.id) {
      ...
      if (!wasApproved && isNowApproved) {
        ...
        // Conversión confirmada — Plan Empresa analytics
        // trackEvent("conversion", { order_id, total, items_count, payment_provider, shipping_carrier })
        // Se dispara desde el cliente cuando MP redirecciona con status=approved
      }
    }
